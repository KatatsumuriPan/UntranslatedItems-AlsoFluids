...
public class TF_GuiCraft__ {
	...
	private static final String TARGET = "appeng.client.gui.implementations.GuiCraftConfirm";
	private static final String TARGET2 = "appeng.client.gui.implementations.GuiCraftingCPU";
	private static final String IAEITEMSTACK = "appeng/api/storage/data/IAEItemStack";
					...
					if ("drawFG".equals(name)) {
						if (Loader.isModLoaded("ae2fc")) {
							mv = new ReplaceInstructionsAdapter(mv, name,
									...
									Instructions.create()
											.invokeStatic("com/glodblock/github/coremod/CoreModHooks", "displayAEFluid", AsmUtil.toMethodDesc(IAEITEMSTACK, IAEITEMSTACK))//2重に呼んでも問題ない
