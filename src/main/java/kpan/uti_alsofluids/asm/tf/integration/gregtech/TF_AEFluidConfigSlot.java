...
public class TF_AEFluidConfigSlot {

	private static final String TARGET = "gregtech.common.gui.widget.appeng.slot.AEFluidConfigSlot";
	private static final String HOOK = AsmTypes.HOOK + "integration/gregtech/" + "HK_" + "AEFluidConfigSlot";
