...
import kpan.uti_alsofluids.config.ConfigAnnotations.EnumValue;
import kpan.uti_alsofluids.config.ConfigAnnotations.FloatValue;
import kpan.uti_alsofluids.config.ConfigAnnotations.IntValue;
import kpan.uti_alsofluids.config.ConfigAnnotations.LongValue;
import kpan.uti_alsofluids.config.ConfigAnnotations.Name;
import kpan.uti_alsofluids.config.ConfigAnnotations.StringValue;
